...
// Put this in bno055.h
typedef struct {
    bno055_vector_t accel;   // Accelerometer
    bno055_vector_t mag;     // Magnetometer
    bno055_vector_t gyro;    // Gyroscope
    bno055_vector_t euler;   // Euler angles
    bno055_vector_t quat;    // Quaternion
    bno055_vector_t linear;  // Linear Acceleration
    bno055_vector_t gravity; // Gravity Vector
} bno055_all_data_t;
